...
public class Deneme {
    public static void main(String[] args) {
       ...
       // System.out.println(ll1.removeIf(v -> v.contains(isim))==true ? "silindi":"yoktu silinemedi");
        ll2.addAll(ll1.stream().filter(v -> v.contains("h")).toList());
        ll2.add(1,"adem");
        System.out.println(ll2);
        System.out.println(ll1);

        //if (ll1.removeIf(v -> v.contains(isim))){
        //    System.out.println("Bu isim LinkedList'de vardi silindi ");
          //  System.out.println(ll1);
